...
const Dashboard: React.FC<DashboardProps> = ({ onStartExam, onStartStudyConfig, onStartFlashcardConfig, onStartWeakestDomainStudy, examHistory, onViewResult, onImportHistory, isAiEnabled, onToggleAiFeatures, theme, setTheme }) => {
          ...
          <div className="lg:col-span-1 bg-white dark:bg-slate-800/50 p-8 rounded-2xl border border-gray-200 dark:border-slate-700 flex flex-col justify-center">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-slate-700">
                ...
                <div className="flex items-center justify-between bg-gray-50 dark:bg-slate-800 p-3 rounded-lg border border-gray-200 dark:border-slate-700">
                    <label htmlFor="ai-toggle" className="text-slate-700 dark:text-slate-300 flex-grow cursor-pointer pr-4">
                        <span className="font-semibold">AI Security Tutor</span>
                        <p className="text-xs text-slate-500 dark:text-slate-400">Enable Gemini-powered explanations for concepts in question reviews.</p>
                    </label>
                    <div className="relative inline-block w-10 align-middle select-none">
                        <input
                            ...
                            className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 border-slate-300 dark:border-slate-600 appearance-none cursor-pointer transition-all duration-300 ease-in-out"
                        />
                        <label htmlFor="ai-toggle" className="toggle-label block overflow-hidden h-6 rounded-full bg-slate-300 dark:bg-slate-600 cursor-pointer transition-all duration-300 ease-in-out"></label>
                    </div>
                </div>
