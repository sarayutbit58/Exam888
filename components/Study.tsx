...
const IconCheckCircle = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 mr-2 text-green-400"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>;
const IconXCircle = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 mr-2 text-red-400"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>;
...
export const Study: React.FC<StudyProps> = ({ questions, onGoToDashboard, flaggedQuestions, onToggleFlag }) => {
  ...
  const getOptionClass = (option: string) => {
    ...
    if (isCorrectAnswer) {
        return 'bg-green-500/20 border-green-500 ring-2 ring-green-500';
    }
    if (isSelectedAnswer && !isCorrectAnswer) {
        return 'bg-red-500/20 border-red-500 ring-2 ring-red-500';
    }
      ...
      <div className="w-full max-w-4xl">
        <header className="mb-6 flex justify-between items-center gap-4">
            ...
            <div className="text-right">
                <h1 className="text-2xl font-bold text-white">Advanced Study Session</h1>
            ...
            {isAnswered && (
                <div className="mt-6 pt-6 border-t border-slate-700 space-y-4 animate-fade-in">
                    {selectedOption === currentQuestion.correctAnswer ? (
                        ...
                        <div className="flex items-center text-red-400 font-bold text-lg"><IconXCircle/> Incorrect.</div>
                    )}
                    <div className="bg-slate-900/50 p-4 rounded-lg">
                        <p className="text-cyan-400 font-semibold mb-2">Explanation:</p>
